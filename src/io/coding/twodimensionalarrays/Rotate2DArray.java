...
public class Rotate2DArray {
    public static void main(String[] args) {
        ...
        //  [8, 5, 2],
        //  [9, 6, 3]]
        System.out.println(Arrays.deepToString(rotateOutPlace(a1, 3)));
        ...
        //  [15, 11, 7, 3],
        //  [16, 12, 8, 4]]
        System.out.println(Arrays.deepToString(rotateOutPlace(a2, 4)));
    }

    // Implement your solution below.
    public static int[][] rotateOutPlace(int[][] a, int n) {
